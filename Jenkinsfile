pipeline {
    ...
    stages {
        stage('Checkout code') {
            steps {
                git branch: 'main', url: 'https://github.com/shashank-ssriv/django-notes-app.git'
                sh 'ls'
            }
        }
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                sh "cd helm-charts/charts/django-notes-app && helm upgrade --install -n internal django-notes-app . --values values.yaml"
            }
        }
    }
}